                    ...
                    <div class="product-details-view-content pt-60">
                        <div class="product-info">
                            ...
                            <div class="d-flex align-items-center">
                                @if(isset($productDetails['brand']) && isset($productDetails['brand']['name']))
                                    <span class="product-details-ref mr-2">Brand: {{ $productDetails['brand']['name'] }}</span>
                                @else
                                    <span class="product-details-ref mr-2">Brand: Not specified</span>
                                @endif
                                @if($totalStock > 0)
                                            ...
                                            <div class="product_desc_info">
                                                <div class="product-review">
                                                    <h5 class="manufacturer">
                                                        @if(isset($relatedProduct['brand']) && isset($relatedProduct['brand']['name']))
                                                            <a href="#">{{ $relatedProduct['brand']['name'] }}</a>
                                                        @else
                                                            <span>Бренд не указан</span>
                                                    @endif
                                                    </h5>
